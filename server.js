...
var api_upload = require('./src/routes/api-upload');
var api_path = require('./src/routes/api-path');
var api_remove = require('./src/routes/api-remove');
var api_update = require('./src/routes/api-update');
var api_html2image = require('./src/routes/api-html2image');
var api_github = require('./src/routes/api-github');
//var log = require('./log');  
